        ...
        <>
            <div className="legal-container">
                ...
                <p><strong>Rivalt</strong><br />
                    Correo Electrónico: contacto@rivalt.example.com</p>
            </div>
            <Footer />
        </>
    );
